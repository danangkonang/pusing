...
<html lang="en">
  ...
  <body>
    <div class="container p-3">
        <form method="POST" action="<?= site_url('welcome/input') ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="tanggal" id="tanggal" placeholder="yyy-mm-dd">
            </div>
            ...
            <div class="form-check">
                <?= form_checkbox("hobi[]", "renang", set_checkbox("hobi[]","renang")) ?>
                <label class="form-check-label" for="defaultCheck1">
                renang
                </label>
            </div>
            <div class="form-check">
                <?= form_checkbox("hobi[]", "mancing", set_checkbox("hobi[]","mancing")) ?>
                <label class="form-check-label" for="defaultCheck1">
                mancing
                </label>
            </div>
            <div class="form-check">
                <?= form_checkbox("hobi[]", "game", set_checkbox("hobi[]","game")) ?>
                <label class="form-check-label" for="defaultCheck1">
                game
                </label>
            </div>
            <div class="form-check">
                <?= form_checkbox("hobi[]", "progamming", set_checkbox("hobi[]","progamming")) ?>
                <label class="form-check-label" for="defaultCheck1">
                    progamming
                </label>
            </div>
            <div class="form-check">
                <?= form_checkbox("hobi[]", "makan", set_checkbox("hobi[]","makan")) ?>
                <label class="form-check-label" for="defaultCheck1">
                    makan
                </label>
            </div>
